...
- After project data loads, the Projects introduction renders one compact localized directory from those same slugs and titles. No-JavaScript, blocked-runtime, early-initialization-failure, and persistent-error states retain nine generated localized summaries with stable project fragments, descriptions, primary actions, and available stack, source, and public-evidence context from `projects.json`.
