...
- Require the standalone `independent-review head=<40-character current head SHA> verdict=pass|fail` format in a non-null review or comment body. Short, stale, wrong-head, legacy verdict-less, and substring matches do not satisfy the gate.
